...
public class ClawCommand extends CommandBase {
    ...
    public ClawCommand(ClawServo claw, BooleanSupplier rotatePos45, BooleanSupplier rotateNeg45, BooleanSupplier openClaw, BooleanSupplier closeClaw, BooleanSupplier upPosition) {
        this.claw = claw;
